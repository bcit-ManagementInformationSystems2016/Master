...
public class VacationController implements Serializable{
	...
	@Inject private PayLevelManager plvlmgr;
	...
	public int getDaysRemaining() {
		if(daysRemaining == 0){
			daysRemaining = vacationManager.getDaysRemaining();
		}
	...
	public Vacation[] getVacayArray() {
		if(vacayArray == null){
			setVacayArray(vacationManager.getEmployeeVacationRequests(Login.currentID));
		}
		return vacayArray;
	}
	...
	public int getTotalDaysAllowed() {
		if(totalDaysAllowed == 0){
			totalDaysAllowed = vacationManager.getDaysAllowed();
		}
		return totalDaysAllowed;
	}
	public void setTotalDaysAllowed() {
		int i = vacationManager.getDaysAllowed();
		totalDaysAllowed = i;
	}
	public int getDays() {
		return days;
	...
	public String goToVacationPage() {
		setEmp(empmgr.getTimesheetValidator(Login.currentID));
	...
	public String createVacation(Vacation v) throws ParseException {
		...
		v.setVacationDaysLeft(vacationManager.getDaysRemaining() - days);
